...
class ChromoChip4(object):
    ...
    def __init__(self, traj, snap_index, energy_bin_width, chipfile, chromatin_bead_size, seed = 1234):
        ...
        max_be = all_be.max()
        input_bins = np.arange(0, max_be+energy_bin_width, energy_bin_width)
